          ...
          {#if !isLoggedIn}
            ...
            <section class="features">
              ...
              <div class="feature-card">
                <h3>Ma Collection</h3>
                <p>
                  Suivez vos livres en cours, gérez vos piles à lire, et classez
                  vos lectures en pause, lues ou abandonnées.
                </p>
              </div>
              <div class="feature-card">
                <h3>Suggestions</h3>
                <p>
                  Laissez-vous surprendre par une sélection renouvelée à chaque
                  visite.
                </p>
              </div>
            </section>
